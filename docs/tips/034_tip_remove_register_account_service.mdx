...
__ヒント提供: [@apuntandoanulo](https://github.com/apuntandoanulo) および更新: [@juandbc](https://github.com/juandbc)__
...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - `register` フォルダー全体を削除します。このフォルダーには `register.component.spec.ts` が含まれています。

### 2.2 Vue

* ___2.2.1___ `src/main/webapp/app/account/register` フォルダー全体を削除します。このフォルダーには `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` が含まれています。
