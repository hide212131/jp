...
__ヒント提供: [@apuntandoanulo](https://github.com/apuntandoanulo) & 更新: [@juandbc](https://github.com/juandbc)__
...
* ___2.1.3___ `src\main\webapp\app\account\account.route.ts` を開き、以下の行を削除します:
  - _ACCOUNT_ROUTES_ array -> `registerRoute `

* ___2.4___ `src\main\webapp\app\home\home.component.html`に移動し、次のブロックを削除します。
* ___2.1.4___ `src\main\webapp\app\home\home.component.html` を開き、以下のブロックを削除します。
```html
...
```ts
* ___2.1.7___ `src\main\webapp\app\shared\login\login.component.ts` を開き、以下のブロックを削除します。
...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - `register.component.spec.ts`を含む`register`フォルダー全体を削除

### 2.2 Vue

* ___2.2.1___ `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue`を含む`src/main/webapp/app/account/register`フォルダー全体を削除

* ___2.2.2___ `src/main/webapp/app/router/account.ts`に移動し、以下の行を削除
...
* ___2.2.3___ `src/main/webapp/app/core/jhi-navbar/jhi-navbar.vue`に移動し、以下のブロックを削除
...
* ___2.2.4___ `src/main/webapp/app/account/login-form/login-form.vue`に移動し、以下のブロックを削除
...
* ___2.2.5___ メッセージファイルを削除： `src/main/webapp/i18n/.../register.json`

* ___2.2.6___ テストファイルを削除 `src/test/javascript/cypress/e2e/account/register-page.cy.ts`
