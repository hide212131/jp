...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - `register` フォルダ全体を削除します。このフォルダには `register.component.spec.ts` が含まれています。

### 2.2 Vue

* ___2.2.1___ `src/main/webapp/app/account/register` フォルダ全体を削除します。このフォルダには `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` が含まれています。
