...
__ヒント提供: [@apuntandoanulo](https://github.com/apuntandoanulo) および 更新者: [@juandbc](https://github.com/juandbc)__
...
* ___2.1.6___ `src\main\webapp\app\shared\login\login.component.html`へ移動し、以下のブロックを削除してください。
