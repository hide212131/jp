...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - `register.component.spec.ts` を含む `register` フォルダー全体を削除します。

### 2.2 Vue

* ___2.2.1___ `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` を含む `src/main/webapp/app/account/register` フォルダー全体を削除します。
