...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - フォルダー全体 `register` を削除します。これには `register.component.spec.ts` が含まれます。

### 2.2 Vue

* ___2.2.1___ フォルダー全体 `src/main/webapp/app/account/register` を削除します。これには `register.component.spec.ts`, `register.component.ts`, `register.service.ts`, `register.vue` が含まれます。
