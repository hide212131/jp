...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - 以下のファイルを含むフォルダー `register` 全体を削除します: `register.component.spec.ts`

### 2.2 Vue

* ___2.2.1___ 以下のファイルを含むフォルダー `src/main/webapp/app/account/register` 全体を削除します: `register.component.spec.ts`, `register.component.ts`, `register.service.ts`, `register.vue`
