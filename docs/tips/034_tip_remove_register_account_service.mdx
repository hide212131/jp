...
__[@apuntandoanulo](https://github.com/apuntandoanulo) によるヒント提供 および [@juandbc](https://github.com/juandbc) による更新__
...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - フォルダー `register` 全体を削除します。これには `register.component.spec.ts` が含まれます。

### 2.2 Vue

* ___2.2.1___ フォルダー `src/main/webapp/app/account/register` 全体を削除します。これには `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` が含まれます。
