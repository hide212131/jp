...
__[@apuntandoanulo](https://github.com/apuntandoanulo)が提供し、[@juandbc](https://github.com/juandbc)が更新したヒント__
...
* ___2.1.4___ `src\main\webapp\app\home\home.component.html` を開いて、以下のブロックを削除してください:
```html
