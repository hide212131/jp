...
__ヒント提供元：[@apuntandoanulo](https://github.com/apuntandoanulo) & 更新：[@juandbc](https://github.com/juandbc)__
...
* ___2.1.3___ `src\main\webapp\app\account\account.route.ts` に移動し、以下の行を削除してください。
...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - `register.component.spec.ts` を含む `register` フォルダ全体を削除します。

### 2.2 Vue

* ___2.2.1___ `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` を含む `src/main/webapp/app/account/register` フォルダ全体を削除します。
