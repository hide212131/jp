...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - `register` フォルダー全体を削除します。これには `register.component.spec.ts` が含まれます。

### 2.2 Vue

* ___2.2.1___ `src/main/webapp/app/account/register` フォルダー全体を削除します。これには `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue` が含まれます。
