...
* ___2.1.9___ `src\test\javascript\spec\app\account`
  - フォルダー `register` 全体を削除します。含まれるもの： `register.component.spec.ts`

### 2.2 Vue

* ___2.2.1___ フォルダー `src/main/webapp/app/account/register` 全体を削除します。含まれるもの： `register.component.spec.ts`、`register.component.ts`、`register.service.ts`、`register.vue`
