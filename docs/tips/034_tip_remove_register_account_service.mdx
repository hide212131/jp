...
__ヒント提供者：[@apuntandoanulo](https://github.com/apuntandoanulo) & 更新者：[@juandbc](https://github.com/juandbc)__
...
* ___2.1.4___ `src\main\webapp\app\home\home.component.html` へ移動し、以下のブロックを削除します:
```html
