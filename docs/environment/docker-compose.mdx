...
[MOCK] Docker Compose is used by default in development, tests and CI scripts, which can be [disabled](#disabling).
## 要旨
...
[MOCK] ## Disabling
[MOCK] 
[MOCK] Add to src/main/resources/application.yml or application-dev.yml depending on your application configuration.
[MOCK] 
[MOCK] ```yaml
[MOCK] spring:
[MOCK]   docker:
...
[MOCK] ## Alternatives
[MOCK] 
[MOCK] - [Colima](https://github.com/abiosoft/colima#getting-started)
