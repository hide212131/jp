---
title: リリース9.0.0
slug: JHipster 9.0.0リリースの2026年3月10日版HTML
...
- **GraalVM support**: spring-boot:graalvm ジェネレータを追加
...
- **完全な TypeScript 再設計**: ジェネレータのコードベースが、改善された型とモジュラーアーキテクチャで TypeScript で完全に書き直されました
...
既存のプロジェクトがある場合、それは生成時に使用されたJHipsterのバージョンを使い続けます。
