...
これは、ベータリリースからのすべての変更に加え、[9.0.0-beta.3](/2026/02/04/jhipster-release-9.0.0-beta.3.html) リリース以降の[442件のクローズされたイシューとプルリクエスト](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0)が含まれるメジャーリリースです。
...
- **Angular 21**: 主な更新点：
  - パフォーマンス向上のためデフォルトで Zoneless に (zone.js は不要に)
...
- **完全な TypeScript リデザイン**: ジェネレーターのコードベースが、型改善とモジュラーアーキテクチャにより TypeScript で完全に書き直されました
