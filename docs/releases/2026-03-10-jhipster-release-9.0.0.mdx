...
これはメジャーリリースであり、ベータ版リリースからのすべての変更に加え、[9.0.0-beta.3](/2026/02/04/jhipster-release-9.0.0-beta.3.html) リリース以降の [442件のクローズされたイシューとプルリクエスト](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0) が含まれています。
...
- **TypeScript による完全な再設計**: ジェネレーターのコードベースが TypeScript で完全に書き直され、型改善とモジュラーアーキテクチャが実現
- yeoman-generator v8 に更新

## クローズされたチケットとマージされたプルリクエスト

これまで通り、**[クローズされたすべてのチケットとマージされたプルリクエストはこちらで確認できます](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0)**。
