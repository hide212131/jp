...
- **完全な TypeScript 再設計**: ジェネレーターのコードベースが TypeScript で完全に書き直され、型改善とモジュラーアーキテクチャを実現
- yeoman-generator v8 に更新

## クローズされたチケットとマージされたプルリクエスト

これまでと同様に、**[すべてのクローズされたチケットとマージされたプルリクエストはこちらで確認できます](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0)**。
