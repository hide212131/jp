...
slug: 2026年2月4日のジェイヒップスターリリース9.0.0ベータ3ドットHTML
...
v9.0.0-beta.3 リリースが利用可能になりました！このリリースには、[9.0.0-beta.2](https://github.com/jhipster/generator-jhipster/releases/tag/v9.0.0-beta.2) 以降、[65件のクローズされたイシューとプルリクエスト](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0-beta.3)が含まれています。
