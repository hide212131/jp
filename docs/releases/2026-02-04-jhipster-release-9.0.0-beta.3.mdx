...
slug: 2026年2月4日のJHipsterリリース9.0.0ベータ3.html
...
v9.0.0-beta.3 リリースが利用可能になりました！このリリースには、[9.0.0-beta.2](https://github.com/jhipster/generator-jhipster/releases/tag/v9.0.0-beta.2) 以降の[65件のクローズされたissueとプルリクエスト](https://github.com/jhipster/generator-jhipster/issues?q=is:closed+milestone:9.0.0-beta.3)が含まれています。
...
### プラットフォームとツールチェーンの更新
- **Java 17のサポートを終了**: Java 21が最低必須バージョンとなりました ([#31903](https://github.com/jhipster/generator-jhipster/pull/31903))
